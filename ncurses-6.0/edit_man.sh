...
(*.[0-9]*)
	...
	if test ! -f /h/asavag04/Projects/Polyhack_2016/rASCIIng/ncurses-6.0/man_alias.sed ; then
cat >>/h/asavag04/Projects/Polyhack_2016/rASCIIng/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /h/asavag04/Projects/Polyhack_2016/rASCIIng/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /h/asavag04/Projects/Polyhack_2016/rASCIIng/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /h/asavag04/Projects/Polyhack_2016/rASCIIng/ncurses-6.0/man_alias.sed \
		< $i >$TMP
